...
llm keys set gemini
```
When prompted, paste your API key. Note that no masked characters will appear as you paste your key. This is normal behavior, just go ahead and hit Enter key once you've pasted the key. 
